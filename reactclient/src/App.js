            ...
            {posts.map((post) => (
              <tr key={post.postId}>
                ...
                <td>
                  ...
                  <button onClick={() => { if(window.confirm(`Are you sure you want ot delete the post "${post.title}" `)) deletePost(post.postId) }} className="btn btn-secondary btn-lg">Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
